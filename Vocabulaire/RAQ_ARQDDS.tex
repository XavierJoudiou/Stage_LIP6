...
\begin{document}
  ...
  \fairetitre{Fiche de Vocabulaire RAQ}{Xavier Joudiou}{22/04/10}
  \infoFicheVocabulaire{RAQ: A Range-Queriable Distributed Data Structure}{Hamid Nazerzadeh, Mohammad Ghodsi}{2004}
