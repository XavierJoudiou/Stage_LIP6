...
\begin{document}
  ...
  \infoFicheLecture{Topologically-Aware Overlay Construction and Server Selection}{Sylvia Ratnasamy, Mark Handley, Richard Karp, Scott Shenker}{2002}{Presentation de Dekar Lyes}{Overlay networks, serveur}
